...
class EnvOutput:
    ...
    def prepare_observations(self, obs: dict[str, Any]) -> dict[str, Any]:
        ...
        main_image_history_tensor = (
            obs["main_image_history"] if "main_image_history" in obs else None
        )
        wrist_image_history_tensor = (
            obs["wrist_image_history"] if "wrist_image_history" in obs else None
        )
        ...
        return {
            ...
            "main_image_history": main_image_history_tensor,  # [N_ENV, T, H, W, C]
            "wrist_image_history": wrist_image_history_tensor,  # [N_ENV, T, H, W, C]
