...
class GR00T_N1_5_ForRLActionPrediction(GR00T_N1_5, BasePolicy):
    ...
    def _spec_sample_actions(
        ...
        *,
        ...
        if prefill is None:
            ...
            prefill = self._build_spec_prefill(normalized_input)
    ...
    def _predict_action_batch_full(
        ...
        normalized_action = self._spec_sample_actions(
            normalized_input,
    ...
    def _speculative_decode_chunk(
        ...
        *,
        ...
        prefill_base = self._build_spec_prefill(normalized_input)
        ...
        actions_raw_t = self._spec_sample_actions(
            None,
        ...
        for order_conf_full, order_seq_full, chunk_start, chunk_end in chunk_orders:
            ...
            verify_actions_raw_t = self._spec_sample_actions(
                None,
                num_steps=int(diffusion_num_steps),
